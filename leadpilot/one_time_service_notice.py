...
BROADCAST_ID = "lead-actions-temporary-outage-2026-08-02-v1"
BROADCAST_TEXT = (
    "⚠️ Временное уведомление\n\n"
    "Сейчас временно недоступны три функции:\n"
    "• «📋 Мои лиды»\n"
    "• «💎 Анализ клиента»\n"
    "• «✉️ Создать сообщение»\n\n"
    "Мы уже работаем над устранением проблемы и делаем всё возможное, "
    "чтобы восстановить их работу как можно скорее. Остальные функции "
    "бота продолжают работать в обычном режиме.\n\n"
